        ...
        <div id="sidebar-menu">
            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="{{ route('add.product') }}" data-key="t-">Add Product</a></li>
                        <li><a href="{{route('all.product')}}" data-key="t-">All Product</a></li>
                    </ul>
                </li>
                ...
                <li>
                    <a href="javascript: void(0);" class="has-arrow">
                        <i data-feather="grid"></i>
                        <span data-key="t-authentication">Galery</span>
                    </a>
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="{{ route('add.gallery') }}" data-key="t-">Add Gallery</a></li>
                        <li><a href="{{route('all.gallery')}}" data-key="t-">All Gallery</a></li>
                    </ul>
                </li>
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="{{ route('add.product') }}" data-key="t-">Add Coupon</a></li>
                        <li><a href="{{route('all.coupon')}}" data-key="t-">All Coupon</a></li>
                    </ul>
                </li>
