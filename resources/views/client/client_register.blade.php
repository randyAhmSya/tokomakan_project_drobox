                                ...
                                <div class="d-flex flex-column h-100">
                                    <div class="mb-4 text-center mb-md-5">
                                        <a href="index.html" class="d-block auth-logo">
                                            <img src="assets/images/logo-sm.svg" alt="" height="28"> <span class="logo-txt">Client Register</span>
                                        </a>
                                    </div>
                                    ...
                                    @endif
                                        ...
                                        <form class="pt-2 mt-4" action="{{route('client.register.submit')}}" method="POST">
                                            @csrf
                                            <div class="mb-3">
