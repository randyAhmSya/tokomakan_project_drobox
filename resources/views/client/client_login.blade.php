                                ...
                                <div class="d-flex flex-column h-100">
                                    <div class="mb-4 text-center mb-md-5">
                                        <a href="index.html" class="d-block auth-logo">
                                            <img src="assets/images/logo-sm.svg" alt="" height="28"> <span class="logo-txt">Client Login</span>
                                        </a>
                                    </div>
                                    <div class="my-auto auth-content">
                                        <div class="text-center">
                                            <h5 class="mb-0">Welcome Back !</h5>
                                            <p class="mt-2 text-muted">Sign in to continue to Client.</p>
                                        </div>
                                    ...
                                    @endif
                                        ...
                                        <form class="pt-2 mt-4" action="{{route('client.login_submit')}}" method="POST">
                                            @csrf
                                            <div class="mb-3">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <div class="input-group auth-pass-inputgroup">
                                                    ...
                                                    <button class="shadow-none btn btn-light ms-0" type="button" id="password-addon"><i class="mdi mdi-eye-outline"></i></button>
                                                </div>
                                            </div>
                                            <div class="mb-4 row">
                                                <div class="col">
                                        ...
                                        <div class="mt-5 text-center">
                                            <p class="mb-0 text-muted">Don't have an account ? <a href="{{ route('client.register') }}"
