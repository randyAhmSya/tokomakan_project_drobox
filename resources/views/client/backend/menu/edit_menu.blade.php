                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div>
                                        <div class="mb-3 form-group">
                                            ...
                                            <input class="form-control" type="text" name="menu_name" value="{{ $menu->menu_name }}"   id="example-text-input">
                                        </div>
                                </div>
                                ...
                                <div class="col-lg-5">
                                    <div class="mt-3 mt-lg-0">
                                        ...
                                        <div class="mb-3">
                                            <img id="showImage" src="{{ asset($menu->image) }}" alt="" class="p-1 rounded-circle bg-primary" width="110">
                                        </div>
                                        <div class="mb-4">
