                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="mb-3 form-group">
                                        <label for="example-text-input" class="form-label">Name Category</label>
                                ...
                                <div class="col-lg-5">
                                    ...
                                    <div class="mb-3">
                                        <img id="showImage" src="{{ asset($category->image) }}" alt="" class="p-1 rounded-circle bg-primary" width="110">
                                    </div>
                                    <div class="mb-4">
