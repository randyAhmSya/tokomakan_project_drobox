                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-3 col-md-6">
                                    <div class="mb-3 form-group">
                                        ...
                                        <select name="category_id" class="form-select" id="category" required>
                                            <option value="" disabled {{ old('category_id', $product->category_id) === null ? 'selected' : '' }}>Select</option>
                                ...
                                <div class="col-xl-3 col-md-6">
                                    <div class="mb-3 form-group">
                                        ...
                                        <select name="menu_id" class="form-select" id="menu" required>
                                            <option value="" disabled {{ old('menu_id', $product->menu_id) === null ? 'selected' : '' }}>Select</option>
                                ...
                                <div class="col-xl-3 col-md-6">
                                    <div class="mb-3 form-group">
                                        ...
                                        <select name="city_id" class="form-select" id="city" required>
                                            <option value="" disabled {{ old('city_id', $product->city_id) === null ? 'selected' : '' }}>Select</option>
                                ...
                                <div class="col-xl-3 col-md-6">
                                    <div class="mb-3 form-group">
                                        ...
                                        <select name="client_id" class="form-select" id="client" required>
                                            <option value="" disabled {{ old('client_id', $product->client_id) === null ? 'selected' : '' }}>Select</option>
